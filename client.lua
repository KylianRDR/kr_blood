...
AddEventHandler('gameEventTriggered', function(name, data)
    if name == 'CEventNetworkEntityDamage' then
        ...
        if IsEntityAPed(victim) and IsEntityAPed(attacker) and IsPedAPlayer(victim) and IsPedAPlayer(attacker) then
            ...
            local hitId = tostring(attacker) ..
                "_" .. tostring(victim) .. "_" .. tostring(weaponHash) .. "_" .. tostring(currentTime)
            ...
            if not lastHitTime[hitId] then
                ...
                if victim == playerPed then
                    ...
                    print("IMPACT: " ..
                        damage ..
                        " degats recu de joueur " ..
                        attackerId .. " sur " .. boneName .. " (Vie: " .. oldHealth .. " -> " .. playerHealth .. ")")
                    TriggerServerEvent('damageSystem:damageReceived', attackerId, GetPlayerServerId(PlayerId()), damage,
                        boneName)
                ...
                if attacker == playerPed then
                    ...
                    TriggerServerEvent('damageSystem:damageDealt', GetPlayerServerId(PlayerId()), victimId, damage,
                        boneName)
                end
            end
        end
